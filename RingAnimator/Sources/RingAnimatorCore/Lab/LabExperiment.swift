...
public enum LabExperiment: String, CaseIterable, Identifiable, Sendable {
    ...
    public var parameters: [LabParameter] {
        ...
        case .sunflower: return [
            ...
            .init("ground", "Ground", 0...2, 0, "White like the original, or dark, or the stage’s. On dark the blooms glow: a halo under the dots, and the dots themselves light up.", "%.0f", group: "Field", choices: ["Stage", "Light", "Dark"]),
            .init("glow", "Dark Glow", 0...1.5, 0.7, "On a dark ground: the halo each bloom casts, and how bright the lit dots go.", group: "Field"),
...
public enum LabSection: String, CaseIterable, Identifiable, Sendable {
    ...
    public var title: String {
        ...
        case .surfaces: return "Containers"
