...
func run() async -> Int32 {
    ...
    check("asking for a smooth GIF still writes a movie",
          ((try? movieURL.resourceValues(forKeys: [.fileSizeKey]).fileSize) ?? 0) ?? 0 > 0,
          "\(((try? movieURL.resourceValues(forKeys: [.fileSizeKey]).fileSize) ?? 0) ?? 0) bytes")
