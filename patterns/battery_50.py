"""battery_50 — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = 9800
RENDER_ONLY = False
DESCRIPTION = ("8-LED white cascade + blink.")


def schedule_battery_50(controller, system):
    return _schedule_battery_cascade(controller, system, TOTAL_LEDS // 2)
