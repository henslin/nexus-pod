"""bluetooth_critical — registered LED-ring pattern (see pattern_common.py)."""
...
def schedule_bluetooth_critical(controller, system):
    """Solid red 3 s (firmware: 2 steps, MEDIUM)."""
    return _schedule_solid_firmware(controller, system, COLOR_RED)
