"""warble_kaleidoscope_green — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = None
RENDER_ONLY = False
DESCRIPTION = ("Kaleidoscope-fold warble, green.")


def schedule_warble_kaleidoscope_green(controller, system):
    """Warble — kaleidoscope fold, forest floor / bright-green accent."""
