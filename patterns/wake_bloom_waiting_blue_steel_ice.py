"""wake_bloom_waiting_blue_steel_ice — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = None
RENDER_ONLY = False
DESCRIPTION = ("Wake-bloom breath (waiting), steel/ice-cyan.")


def schedule_wake_bloom_waiting_blue_steel_ice(controller, system):
    """Wake bloom, steel-blue floor / ice-cyan accent."""
    return _schedule_wake_bloom(controller, system, (18, 42, 66), (120, 210, 255))
