"""power_on_success — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = 4000
RENDER_ONLY = False
DESCRIPTION = ("Solid white 3 s then off.")


def schedule_power_on_success(controller, system):
    """Solid white 3 s, then fade off (firmware: 2 steps, MEDIUM)."""
    return _schedule_solid_firmware(controller, system, COLOR_WHITE)
