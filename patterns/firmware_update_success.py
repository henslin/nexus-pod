"""firmware_update_success — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = 3000
RENDER_ONLY = False
DESCRIPTION = ("Solid green 3 s (firmware update done).")


def schedule_firmware_update_success(controller, system):
    """Solid green 3 s; renderer auto-offs (firmware: 1 step, MEDIUM)."""
    return _schedule_solid_firmware(controller, system, COLOR_GREEN, off_ms=0)
