"""bluetooth_pairing — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = None
RENDER_ONLY = False
DESCRIPTION = ("Dual blue comet, same speed.")


def schedule_bluetooth_pairing(controller, system):
    """Dual blue comet (CW + CCW), one rotation, FAST, 312 ms/frame. Byte-matches
    firmware bluetooth_pairing (16x SPIN_FRAME(cw, ccw, RGB_BLUE))."""
    return _schedule_spin_firmware(controller, system, COLOR_BLUE)
