"""wifi_failed — registered LED-ring pattern (see pattern_common.py)."""
...
from patterns.bluetooth_failed import schedule_bluetooth_failed   # noqa: F401
...
def schedule_wifi_failed(controller, system):
    return schedule_bluetooth_failed(controller, system)
