"""braided_twist_green — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = None
RENDER_ONLY = False
DESCRIPTION = ("Two phase-opposed strands crossing, green.")


def schedule_braided_twist_green(controller, system):
    """Braided twist, forest floor / spring-green accent."""
    return _schedule_braided_twist(controller, system,
                                   (10, 61, 26), (74, 222, 128))
