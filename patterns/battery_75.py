"""battery_75 — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = 12300
RENDER_ONLY = False
DESCRIPTION = ("12-LED white cascade + blink.")


def schedule_battery_75(controller, system):
    return _schedule_battery_cascade(controller, system, 3 * TOTAL_LEDS // 4)
