"""warble_kaleidoscope_red — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = None
RENDER_ONLY = False
DESCRIPTION = ("Kaleidoscope-fold warble, red.")


def schedule_warble_kaleidoscope_red(controller, system):
    """Warble — kaleidoscope fold, dark-red floor / bright-red accent."""
