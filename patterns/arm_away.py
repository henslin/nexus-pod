"""arm_away — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = 9400
RENDER_ONLY = False
DESCRIPTION = ("Arm Away: red CW comet x2 laps, solid 3 s, fade out.")


def schedule_arm_away(controller, system):
    """Arm Away: RED clockwise comet x2 laps -> solid red -> fade out. ~9.4 s."""
    return _schedule_spin_solid_fade(controller, system, ARM_AWAY_RED)
