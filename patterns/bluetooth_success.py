"""bluetooth_success — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = 4000
RENDER_ONLY = False
DESCRIPTION = ("Solid blue 3 s.")


def schedule_bluetooth_success(controller, system):
    return _schedule_solid_firmware(controller, system, COLOR_BLUE)
