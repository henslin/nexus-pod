"""wake_bloom_waiting_blue_navy_cobalt — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = None
RENDER_ONLY = False
DESCRIPTION = ("Wake-bloom breath (waiting), navy/cobalt.")


def schedule_wake_bloom_waiting_blue_navy_cobalt(controller, system):
    """Wake bloom, midnight-navy floor / cobalt accent."""
    return _schedule_wake_bloom(controller, system, (8, 20, 56), (30, 90, 230))
