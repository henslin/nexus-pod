"""wifi_critical — registered LED-ring pattern (see pattern_common.py)."""
...
from patterns.bluetooth_critical import schedule_bluetooth_critical   # noqa: F401

DURATION_MS = 4000
RENDER_ONLY = False
DESCRIPTION = ("Solid red 3 s.")


def schedule_wifi_critical(controller, system):
    return schedule_bluetooth_critical(controller, system)
