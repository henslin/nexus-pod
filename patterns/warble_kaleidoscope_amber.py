"""warble_kaleidoscope_amber — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = None
RENDER_ONLY = False
DESCRIPTION = ("Kaleidoscope-fold warble, amber.")


def schedule_warble_kaleidoscope_amber(controller, system):
    """Warble — kaleidoscope fold, dark-amber floor / bright-amber accent."""
    return _schedule_warble_kaleidoscope(controller, system,
                                         (60, 35, 5), (255, 170, 40))
