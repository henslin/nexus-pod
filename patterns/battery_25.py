"""battery_25 — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = 7300
RENDER_ONLY = False
DESCRIPTION = ("4-LED white cascade + blink.")


def schedule_battery_25(controller, system):
    return _schedule_battery_cascade(controller, system, TOTAL_LEDS // 4)
