"""warble_kaleidoscope_blue — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = None
RENDER_ONLY = False
DESCRIPTION = ("Kaleidoscope-fold warble, blue.")


def schedule_warble_kaleidoscope_blue(controller, system):
    """Warble — kaleidoscope fold, deep-indigo floor / sapphire accent."""
