"""wifi_pairing_varied_speed — registered LED-ring pattern (see pattern_common.py)."""
...
DURATION_MS = None
RENDER_ONLY = False
DESCRIPTION = ("Dual green comet, 13% speed diff.")


def schedule_wifi_pairing_varied_speed(controller, system):
    return _dual_comet_varied(controller, system, COLOR_GREEN, trail_brightness=0.3)
