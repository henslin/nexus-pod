...
# Cue: Plug-in power up (Onboarding · Power Up)
# Style: Pulse (Accelerating), then Fade
#
# Spec sheet reference: White Solid (10s is the estimated duration for Ziris boot up)
#
...
NEXUS_PARAMS = {
    "style": "pulseAccelerateThenSolidFade",
    "animation_type": "Wave",
    "easing": "Linear",
    "speed": 1.0,
    "diameter": 160,
    ...
    "trail_fraction": 0.22,
    "diode_count": 30,
    "chasing_draw_undraw": False,
    "flash_count": 0,
    "hold_seconds": 1.5,
    "fade_out_seconds": 0.6,
    "primary_color": "#2E7BFF",
